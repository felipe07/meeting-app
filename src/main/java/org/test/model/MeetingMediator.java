...
public class MeetingMediator {
    ...
    public String selectMeetingPresenter(String participantName, String meetingSubject) throws PresenterAlreadySelected {
        ...
        return String.format("%s selected as %s for meeting %s on %s", new Object[]{participantName, MeetingRole.PRESENTER, meetingSubject, df.format(new Date())});
    }
    ...
    public String deselectMeetingPresenter(String participantName, String meetingSubject) {
        ...
        return String.format("%s deselected as %s for meeting %s on %s", new Object[]{participantName, MeetingRole.PRESENTER, meetingSubject, df.format(new Date())});
    }
